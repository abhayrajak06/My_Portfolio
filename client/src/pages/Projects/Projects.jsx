            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <p className="text-center mt-4" style={{ fontWeight: "bold" }}>
                  ...
                  Ratione possimus, consectetur distinctio molestias odio aut
                  suscipit quas incidunt minima saepe ab, est culpa placeat
                  eaque excepturi deserunt architecto aliquid reprehenderit.
                </p>
              </div>
            </div>
